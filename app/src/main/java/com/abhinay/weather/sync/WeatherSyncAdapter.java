...
import com.abhinay.weather.MainActivity;
import com.abhinay.weather.R;
import com.abhinay.weather.Utility;
import com.abhinay.weather.data.WeatherContract;
...
public class WeatherSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, "2ebff306fcf808fde9011da6fdda25ad")
                    .build();
    ...
    /**
     *  method to schedule the sync adapter periodic execution
     */
